...
namespace Boardgame
{
	namespace Effect
    {
		public class ChoiceButtons : BaseEffect 
		{
            ...
            public void AddButtons(List<UnityAction<Rulesets.Ruleset>> choices, List<string> descriptions)
            {
                ...
                for (int i = 0; i < choices.Count; i++)
                {
                    ...
                    choiceOptions[i].onClick.AddListener(delegate { choices[i](Game.GetRules()); }); // Tell it to run Method i
